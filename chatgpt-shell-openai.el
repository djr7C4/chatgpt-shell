...
(cl-defun chatgpt-shell-openai-make-model (&key version short-version token-width context-window validate-command (url-base chatgpt-shell-api-url-base) (provider "OpenAI") other-params)
