...
| chatgpt-shell-ignored-model-versions                             | The list of model versions to ignore when swapping the model.                |
...
| chatgpt-shell-allowed-model-versions                             | The list of model versions to show when swapping the model. This             |
